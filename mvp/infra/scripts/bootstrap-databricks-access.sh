...
case "$TARGET" in
  foundation)
    ...
    export DATABRICKS_ACCESS_GRANT_SOURCES="${DATABRICKS_ACCESS_GRANT_SOURCES:-${TOP_OPPORTUNITIES_SOURCE:-${CUSTOMER_TOP_OPPORTUNITIES_SOURCE:-}},${CONTACTS_SOURCE:-${CUSTOMER_CONTACTS_SOURCE:-}}}"
