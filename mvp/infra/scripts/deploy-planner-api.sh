...
if [[ "${SECURE_DEPLOYMENT:-false}" =~ ^([Tt][Rr][Uu][Ee]|1|[Yy][Ee]?[Ss]|[Oo][Nn])$ || "${DEPLOYMENT_MODE,,}" == "secure" || "${DEPLOYMENT_MODE,,}" == "true" || -n "${DATABRICKS_HOST:-}" || -n "${CUSTOMER_DATABRICKS_HOST:-}" ]]; then
...
SALES_TEAM_MAPPING_USER_COLUMN="${SALES_TEAM_MAPPING_USER_COLUMN:-${CUSTOMER_SALES_TEAM_MAPPING_USER_COLUMN:-user_upn}}"
SALES_TEAM_MAPPING_TEAM_COLUMN="${SALES_TEAM_MAPPING_TEAM_COLUMN:-${CUSTOMER_SALES_TEAM_MAPPING_TEAM_COLUMN:-sales_team}}"
SALES_TEAM_STATIC_MAP_JSON_PATH="${SALES_TEAM_STATIC_MAP_JSON_PATH:-${CUSTOMER_SALES_TEAM_STATIC_MAP_JSON_PATH:-}}"
SALES_TEAM_STATIC_MAP_JSON="${SALES_TEAM_STATIC_MAP_JSON:-${CUSTOMER_SALES_TEAM_STATIC_MAP_JSON:-}}"
...
common_env_vars=(
  ...
  "TOP_OPPORTUNITIES_QUERY=${TOP_OPPORTUNITIES_QUERY:-}"
  "TOP_OPPORTUNITIES_CATALOG=${TOP_OPPORTUNITIES_CATALOG:-}"
  "TOP_OPPORTUNITIES_SCHEMA=${TOP_OPPORTUNITIES_SCHEMA:-}"
  "TOP_OPPORTUNITIES_TABLE=${TOP_OPPORTUNITIES_TABLE:-}"
  "SCOPE_ACCOUNTS_SOURCE=${SCOPE_ACCOUNTS_SOURCE:-}"
  "SCOPE_ACCOUNTS_STATIC_JSON_PATH=${SCOPE_ACCOUNTS_STATIC_JSON_PATH:-}"
  "SCOPE_ACCOUNTS_QUERY=${SCOPE_ACCOUNTS_QUERY:-}"
  "SCOPE_ACCOUNTS_CATALOG=${SCOPE_ACCOUNTS_CATALOG:-}"
  "SCOPE_ACCOUNTS_SCHEMA=${SCOPE_ACCOUNTS_SCHEMA:-}"
  "SCOPE_ACCOUNTS_TABLE=${SCOPE_ACCOUNTS_TABLE:-}"
  ...
  "SALES_TEAM_MAPPING_SOURCE=${SALES_TEAM_MAPPING_SOURCE:-}"
  "SALES_TEAM_MAPPING_QUERY=${SALES_TEAM_MAPPING_QUERY:-}"
  "SALES_TEAM_MAPPING_CATALOG=${SALES_TEAM_MAPPING_CATALOG:-}"
  "SALES_TEAM_MAPPING_SCHEMA=${SALES_TEAM_MAPPING_SCHEMA:-}"
  "SALES_TEAM_MAPPING_TABLE=${SALES_TEAM_MAPPING_TABLE:-}"
  "SALES_TEAM_MAPPING_USER_COLUMN=${SALES_TEAM_MAPPING_USER_COLUMN:-user_upn}"
  "SALES_TEAM_MAPPING_TEAM_COLUMN=${SALES_TEAM_MAPPING_TEAM_COLUMN:-sales_team}"
  "SALES_TEAM_STATIC_MAP_JSON_PATH=${SALES_TEAM_STATIC_MAP_JSON_PATH:-}"
  "SALES_TEAM_STATIC_MAP_JSON=${SALES_TEAM_STATIC_MAP_JSON:-}"
)
