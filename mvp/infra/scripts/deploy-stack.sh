...
ENV_FILE="$ENV_FILE" DEPLOYMENT_MODE="$DEPLOYMENT_MODE" "$INFRA_SCRIPTS_DIR/deploy-top-opportunities-app.sh"
ENV_FILE="$ENV_FILE" DEPLOYMENT_MODE="$DEPLOYMENT_MODE" "$INFRA_SCRIPTS_DIR/deploy-mcp-server.sh"
...
ENV_FILE="$ENV_FILE" DEPLOYMENT_MODE="$DEPLOYMENT_MODE" "$INFRA_SCRIPTS_DIR/validate-top-opportunities-app.sh"
ENV_FILE="$ENV_FILE" DEPLOYMENT_MODE="$DEPLOYMENT_MODE" "$INFRA_SCRIPTS_DIR/validate-mcp-service-e2e.sh"
